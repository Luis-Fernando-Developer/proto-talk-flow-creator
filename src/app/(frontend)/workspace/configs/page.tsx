...
import { Bell, Building2, CreditCard, Key, Plug, Shield, Users } from 'lucide-react'
  ...
  return (
    <div className=" bg-gray-200/40 py-10 px-6 flex w-full flex-col items-center justify-start gap-4 ">
      <div className="flex-1 w-full text-left">
        ...
        <span className=' text-sm'>Gerencie sua empresa, workspace e preferências</span>
      </div>
      <div className="w-full">
        <Tabs defaultValue='integration' className='w-full'>
          ...
          <TabsContent value="workspace">
            <div><WorkspaceConfig /> </div>
          </TabsContent>
          <TabsContent value="preference">
            <div><Preference /></div>
          </TabsContent>
          <TabsContent value="security">
            <div><SecurityConfig /></div>
          </TabsContent>
          <TabsContent value="key">
            <div><KeysApi /></div>
          </TabsContent>
          <TabsContent value="integration">
            <div><IntegrationsSettings /></div>
          </TabsContent>
