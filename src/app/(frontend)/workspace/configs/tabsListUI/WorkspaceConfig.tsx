      ...
      <Card>
        ...
        <CardContent className='flex flex-col gap-4'>
          ...
          <div className="space-y-1">
              ...
              render={({ field }) => (
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent defaultValue="america/saopaulo">
                    <SelectItem value="america/saopaulo">America/Sao Paulo (GMT-3)</SelectItem>
            ...
            />
            {errors.fusoHours && <p className="text-red-500">{errors.fusoHours.message}</p>}
          </div>
          <div className="space-y-1">
            <Label> Idioma</Label>
            <Controller
            ...
            <div className="space-y-2">
              <div className="flex flex-col gap-2 justify-between ">
                {members.map((member, item) => (
                  <div key={item} className='flex flex-col p-3 gap-2 rounded-2xl bg-gray-200/40 '>
