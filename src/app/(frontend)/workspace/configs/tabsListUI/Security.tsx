          ...
          <div className='flex justify-center items-center w-full p-4 border rounded-lg'>
            <div className='flex justify-between items-center w-full gap-2'>
              ...
              <CardHeader className='p-0 px-0.5 -space-y-0'>
                ...
                <CardDescription className='text-xs'>Use o Google Authenticator ou similar</CardDescription>
              </CardHeader>
          ...
          <div className='bg-red-300/40 flex justify-center items-center w-full  border border-red-300/60 rounded-xl'>
            <div className=' p-4 gap-3 flex flex-col w-full'>
              <CardHeader className='p-0 text-left'> 
                ...
                <CardDescription>Baixe uma cópia de todos os seus dados</CardDescription>
              </CardHeader>
              <Button className=' w-full' variant="outline"><Download  />Exportar</Button>
            </div>
          </div>
          <div className='bg-red-300/40 flex  w-full  border border-red-300/60 rounded-xl'>
            <div className=' p-4 gap-3 flex flex-col w-full'>
              <CardHeader className='p-0 text-left '>
                ...
                <CardDescription>Isso Removerá permanentemente sua conta e todos os dados</CardDescription>
              </CardHeader>
              <Button className='text-red-600 w-full' variant="outline"><Trash2 />Excluir conta</Button>
            </div>
          </div>
        </CardContent> 
      </Card>
